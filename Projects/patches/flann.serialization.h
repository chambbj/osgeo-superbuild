...
// normally we would check for _MSC_VER, but this patch is only applied on
// Windows, so it is "kind of" implied -- actually _MSC_VER was coming up
// undefined when using NMake, which seems a little curious still
#ifdef _MSC_VER
